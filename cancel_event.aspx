<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cancel_event.aspx.cs" Inherits="cancel_event" %>
...
<body background="images/t3.jpg">
    ...
    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
        Text="Remove Event" BackColor="#FFFF66" Font-Bold="True" ForeColor="Red" />
            </td>
        </tr>
    </table>
    </form>
